...
public class OriginNightVisionEvents {
    ...
    private static final Set<ResourceLocation> NIGHT_VISION_ORIGINS = Set.of(
    ...
    public static void onPlayerTick(LivingEvent.LivingTickEvent event) {
        ...
        boolean hasOrigin = hasNightVisionOrigin(player);
    ...
    private static boolean hasNightVisionOrigin(Player player) {
        ...
        return NIGHT_VISION_ORIGINS.contains(origin.location());
        }).orElse(false);
    }
}
